  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      ...
      <p className="mb-6 text-slate-600 leading-relaxed">
        These pages keep each GA interaction isolated so browser tests can exercise real route changes and focused user
        flows.
      </p>
      <ul className="space-y-2 text-slate-600">
        ...
        <li>
          <Link to="/tests/get-client-id" className="font-medium text-slate-800 underline underline-offset-2">
            Get client ID
          </Link>
        </li>
        <li>
        ...
        <li>
          <Link to="/tests/stability" className="font-medium text-slate-800 underline underline-offset-2">
